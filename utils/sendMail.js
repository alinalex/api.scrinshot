  ...
  if (emailType === 'email-confirmation') {
    msg = {
      ...
      html: `<p>Hi ${user.name},</p>
             ...
             <p><a href="http://localhost:3000/account/activate/${user.emailVerificationToken}">Activate your account</a></p>
             <p>Kind regards,</p>
             <p>The Scrinshot Team</p>
             <p>Is the link not working? Please copy the following URL in your address bar: <a href="http://localhost:3000/account/activate/${user.emailVerificationToken}">http://localhost:3000/account/activate/${user.emailVerificationToken}</a></p>`,
    };
    ...
    msg = {
      ...
      html: `<p>Hello,</p>
             ...
             <p><a href="http://localhost:3000/auth/forgot-password/${user.passwordResetToken}">Reset password</a></p>
             <p>If you did not request a password reset, no further action is required.</p>
             <p>Kind regards,</p>
             <p>The Scrinshot Team</p>
             <p>Is the link not working? Please copy the following URL in your address bar: <a href="http://localhost:3000/auth/forgot-password/${user.passwordResetToken}">http://localhost:3000/auth/forgot-password/${user.passwordResetToken}</a></p>`,
    };
    ...
    msg = {
      ...
      html: `<p>Hello,</p>
             ...
             <p>You can find the first screenshot image in <a href="http://localhost:3000/screenshots/my-screenshots">My Screenshots</a>.
             <p>Kind regards,</p>
             <p>The Scrinshot Team</p>`,
    };
    ...
    msg = {
      ...
      html: `<p>Hello,</p>
             ...
             <p>You can find it in <a href="http://localhost:3000/screenshots/my-screenshots">My Screenshots</a>.
             <p>Kind regards,</p>
             <p>The Scrinshot Team</p>`,
    };
    ...
    msg = {
      ...
      html: `<p>Hello,</p>
             ...
             <p>You can go and change it in <a href="http://localhost:3000/screenshots/my-screenshots">My Screenshots</a>.
             <p>Kind regards,</p>
             <p>The Scrinshot Team</p>`,
    };
  }
